...
const (
	Demo_GetID_FullMethodName = "/demo.Demo/getID"
)
...
func (c *demoClient) GetID(ctx context.Context, in *DemoRequest, opts ...grpc.CallOption) (*DemoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DemoResponse)
	err := c.cc.Invoke(ctx, Demo_GetID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DemoServer interface {
	//rpc方法
	GetID(context.Context, *DemoRequest) (*DemoResponse, error)
...
func (UnimplementedDemoServer) GetID(context.Context, *DemoRequest) (*DemoResponse, error) {
...
func _Demo_GetID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DemoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DemoServer).GetID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Demo_GetID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DemoServer).GetID(ctx, req.(*DemoRequest))
	}
