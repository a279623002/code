<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:63:"D:\phpStudy\WWW\code./application/admin\view\index\content.html";i:1527066427;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<body>
	...
	<div class="head">
		...
		<ul class="headlink pull-right">
			<li class="link_0"><a href="javascript:;">您好，<?php echo $name; ?></a></li>
			...
			<dl>
				...
				<dd>
					<ul class="clearfix">
						...
						<li><a href="javascript:;" _link="userList">用户管理</a></li>
					</ul>
				</dd>
			</dl>
			<dl>
	...
	<div class="rightmain" id="rightmain">
	 ...
	 <script src="/public/static/public/js/jquery-3.1.1.js"></script>
	  ...
	  <script src="/public/static/public/js/banner.js"></script>
	  <script type="text/javascript">
		...
		$(".leftmenu dl dt").click(function(){
			 if(false == $(this).siblings("dd").is(":visible")){
			 	$(this).css('background-position','right -30px');//如果不可见点击后变蓝色
			}else{
