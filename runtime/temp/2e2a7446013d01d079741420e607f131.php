<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"D:\phpStudy\WWW\code./application/admin\view\index\index.html";i:1534313662;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<body>
	<div class="login">
		<div class="loginmain">
			<h2>登录管理系统</h2>
			<form action="#" class="form-horizontal" id="loginbox">
